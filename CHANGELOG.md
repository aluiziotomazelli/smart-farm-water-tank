...
### Changed
- New `ota_manager` version, clear notification bits and purge stale cancel bits on start_ota.

## [0.4.2] - 2026-08-29

### Changed
- Refactor WaterTankApp::process_pending_ota to save storage before reboot on successful OTA, rearm btn_trigger after failed OTA.
